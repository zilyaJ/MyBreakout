...
public class GameWin2 {
	...
	//菜单初始化
	public GameWin2(Bitmap bmpGameWin, Bitmap bmpBack, Bitmap bmpReplay, Bitmap bmpNext) {
	...
	public void draw(Canvas canvas, Paint paint) {
		...
		//canvas.drawText("You got: "+Brick2.score+" seeds!", 120 , MySurfaceView.screenH/2 + 20, paint);
