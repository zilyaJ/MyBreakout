...
public class Brick {
	...
	//砖的构造函数
	public Brick(Bitmap bmpBrick1,Bitmap bmpBrick2,Bitmap bmpBrick3,Bitmap bmpBrick4,Bitmap bmpBrick5,Bitmap bmpBrick6,Bitmap bmpBrick7,Bitmap bmpBrick8,Bitmap bmpBrick9,Bitmap bmpSeed, Bitmap bmpSeed1) {
		//砖的属性
	...
	public void draw(Canvas canvas, Paint paint) {
		...
		for (int i = 0; i < 64 ; i++) {
			...
			if (brick_exist[i]) {
				...
				switch(i){
					case 0:case 1:case 2:case 3:case 8:case 10:case 16:case 17:case 24:
						canvas.drawBitmap(bmpBrick1, brick_left, brick_top, paint);
						break;
					case 4:case 5:case 6:case 7:case 13:case 15:case 22:case 23:case 31:
					    canvas.drawBitmap(bmpBrick2, brick_left, brick_top, paint);
					    break;
			        case 32:case 40:case 41:case 48:case 50:case 56:case 57:case 58:case 59:
					    canvas.drawBitmap(bmpBrick3, brick_left, brick_top, paint);
					    break;
				    case 39:case 46:case 47:case 53:case 55:case 60:case 61:case 62:case 63:
					    canvas.drawBitmap(bmpBrick4, brick_left, brick_top, paint);
					    break;
				    case 11:case 12:case 18:case 21:case 25:case 30:case 33:case 38:case 42:case 45:case 51:case 52:
					    canvas.drawBitmap(bmpBrick5, brick_left, brick_top, paint);
					    break;
				    case 19:case 20:case 26:case 29:case 34:case 37:case 43:case 44:
					    canvas.drawBitmap(bmpBrick6, brick_left, brick_top, paint);
					    break;
	 ...
	 public boolean onTouchEvent(MotionEvent event) {   
		if(win){
		    ...
		    if (event.getAction()== MotionEvent.ACTION_DOWN && pointY >= 100){
		    	MySurfaceView.gameState = MySurfaceView.GAME_WIN;
