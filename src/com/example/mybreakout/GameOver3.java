...
public class GameOver3 {
	...
	//菜单初始化
	public GameOver3(Bitmap bmpGameOver, Bitmap bmpBack, Bitmap bmpReplay) {
	...
	public void draw(Canvas canvas, Paint paint) {
		...
		//canvas.drawText("You got: "+Brick3.score+" seeds!", 120 , MySurfaceView.screenH/2, paint);
	}
